...
<body>
<c:set var="stringUrl" value="/admin/danh-muc" />
    ...
    <div class="container">
        ...
        <div>
            <div style="display: flex; justify-content: space-between">
                <div>
                    <a href="/admin/danh-muc/them-moi">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; gap: 10px">
                                <a href="/danh-muc/chi-tiet?id=${el.id}" class="btn btn-outline-success">Detail</a>
                                <a href="/danh-muc/cap-nhat?id=${el.id}" class="btn btn-outline-warning">
                                    Edit
                                </a>
                                <a href="/danh-muc/delete?id=${el.id}">
