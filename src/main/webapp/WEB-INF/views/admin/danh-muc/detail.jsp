...
<div style="display: flex">
    <jsp:include page="../layout/_sidebar.jsp">
        <jsp:param name="isDm" value="true" />
    </jsp:include>
        ...
        <div class="card card-body">
            <form:form method="post" action="${isUpdate ? 'cap-nhat' : 'them-moi'}" class="row g-3 needs-validation"
                ...
                <div class="col-md-6">
                    ...
                    <form:input path="maDanhMuc" type="text" class="form-control" disabled="${isDetail}"/>
                    <form:errors path="maDanhMuc" class="text-danger"/>
                </div>

                <div class="col-md-6">
                    <label for="tenDanhMuc" class="form-label">Tên danh mục</label>
                    <form:input path="tenDanhMuc" type="text" class="form-control" disabled="${isDetail}"/>
                    <form:errors path="tenDanhMuc" class="text-danger"/>
                </div>
                ...
                <div class="col-12" style="display: flex; gap: 10px">
                    ...
                    <a class="btn btn-secondary" href="/admin/danh-muc/index">
                        Cancel
                    </a>
                </div>
            </form:form>
