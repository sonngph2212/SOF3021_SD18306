                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; gap: 10px">
                                <a href="/admin/kich-co/chi-tiet?id=${el.id}" class="btn btn-outline-success">Detail</a>
                                <a href="/admin/kich-co/cap-nhat?id=${el.id}" class="btn btn-outline-warning">
                                    Edit
                                </a>
                                <a href="/admin/kich-co/delete?id=${el.id}">
