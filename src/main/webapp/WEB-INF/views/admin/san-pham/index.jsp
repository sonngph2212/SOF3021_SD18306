    ...
    <div class="container">
        ...
        <div>
            <div style="display: flex; justify-content: space-between">
                <div>
                    <a href="/admin/san-pham/them-moi">
            ...
            <table class="table table-sm table-striped">
                ...
                <c:forEach items="${pages.content}" var="el" varStatus="st">
                    <tr>
                        ...
                        <td>${el.getStatus()}</td>
                        <td>${el.ngayTao}</td>
                        <td>${el.danhMucDto.tenDanhMuc}</td>
                        <td>
                            <div style="display: flex; gap: 10px">
                                <a href="/admin/san-pham/chi-tiet?id=${el.id}" class="btn btn-outline-success">Chi tiết</a>
                                <a href="/admin/san-pham/cap-nhat?id=${el.id}">
                                    <button class="btn btn-outline-warning">Edit</button>
                                </a>
                                <a href="/admin/san-pham/delete?id=${el.id}">
