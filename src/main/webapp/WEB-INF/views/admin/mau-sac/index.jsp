                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; gap: 10px">
                                <a href="/admin/mau-sac/chi-tiet?id=${el.id}" class="btn btn-outline-success">Detail</a>
                                <a href="/admin/mau-sac/cap-nhat?id=${el.id}" class="btn btn-outline-warning">
                                    Edit
                                </a>
                                <a href="/admin/mau-sac/delete?id=${el.id}">
