...
<div style="display: flex">
    <jsp:include page="../layout/_sidebar.jsp">
        <jsp:param name="isMs" value="true" />
    </jsp:include>
    <div class="container mt-5">
        ...
        <div class="card card-body">
            <form:form method="post" action="${isUpdate ? 'cap-nhat' : 'them-moi'}" class="row g-3 needs-validation"
                ...
                <div class="col-md-6">
                    <label for="maMau" class="form-label">Mã</label>
                    <form:input path="maMau" type="text" class="form-control" disabled="${isDetail}"/>
                    <form:errors path="maMau" class="text-danger"/>
                </div>

                <div class="col-md-6">
                    <label for="tenMau" class="form-label">Tên</label>
                    <form:input path="tenMau" type="text" class="form-control" disabled="${isDetail}"/>
                    <form:errors path="tenMau" class="text-danger"/>
                </div>
                ...
                <div class="col-12" style="display: flex; gap: 10px">
                    ...
                    <a class="btn btn-secondary" href="/admin/mau-sac/index">
                        Cancel
                    </a>
                </div>
            </form:form>
