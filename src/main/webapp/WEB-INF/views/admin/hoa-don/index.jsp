                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; gap: 10px">
                                <a href="/admin/hoa-don/chi-tiet?id=${el.id}" class="btn btn-outline-success">Detail</a>
                                <a href="/admin/hoa-don/cap-nhat?id=${el.id}" class="btn btn-outline-warning">
                                    Edit
                                </a>
                                <a href="/admin/hoa-don/delete?id=${el.id}">
