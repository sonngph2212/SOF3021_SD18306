...
<div style="display: flex">
    <jsp:include page="../layout/_sidebar.jsp">
        <jsp:param name="isKh" value="true" />
    </jsp:include>
    <div class="container">
        ...
        <div>
            <div style="display: flex; justify-content: space-between">
                <div>
                    <a href="/admin/khach-hang/them-moi">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; gap: 10px">
                                <a href="/admin/khach-hang/chi-tiet?id=${el.id}" class="btn btn-outline-success">Detail</a>
                                <a href="/admin/khach-hang/cap-nhat?id=${el.id}" class="btn btn-outline-warning">
                                    Edit
                                </a>
                                <a href="/admin/khach-hang/delete?id=${el.id}">
