        ...
        <div class="card card-body">
            <form:form method="post" action="${isUpdate ? 'cap-nhat' : 'them-moi'}" class="row g-3 needs-validation"
                ...
                <div class="col-md-6">
                    ...
                    <form:input path="hoTen" type="text" class="form-control" disabled="${isDetail}"/>
                    <form:errors path="hoTen" class="text-danger"/>
                </div>
                <div class="col-md-6">
                    <label for="diaChi" class="form-label">Đỉa chỉ</label>
                    <form:input path="diaChi" type="text" class="form-control" disabled="${isDetail}"/>
                    <form:errors path="diaChi" class="text-danger"/>
                </div>
                <div class="col-md-6">
                    <label for="sdt" class="form-label">Số điện thoại</label>
                    <form:input path="sdt" type="text" class="form-control" disabled="${isDetail}"/>
